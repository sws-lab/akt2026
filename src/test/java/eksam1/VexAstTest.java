...
public class VexAstTest {
    ...
    public void test07_keywordvars() {
        fail("See test avalikustatakse pärast eksamit! Muutujad x, y, L ja R kattuvad märksõnadega; need peavad siiski mõlemas rollis töötama, näiteks \"RR\" on muutuja \"R\" paremale pööratud.");
    }
