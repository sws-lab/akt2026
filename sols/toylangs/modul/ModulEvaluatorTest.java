...
public class ModulEvaluatorTest {
    ...
    public void test07_overflow_pow() {
        checkEval(prog(pow(num(2), 100), 7), 2);
        checkEval(prog(pow(num(2), 100), 1009), 164);
        checkEval(prog(pow(num(7), 100), 1009), 227);
        checkEval(prog(pow(num(1000000000), 2), 1009), 707); // kas vahepealne num on ka normaliseeritud?
    }
    ...
    public void test08_multiple() {
        ...
        checkEval(prog(one, 256), 1);
        checkEval(prog(one_neg, 256), 255);
        checkEval(prog(add(one, one), 256), 2);
        checkEval(prog(add(one_neg, one), 256), 0);
        checkEval(prog(add(one_neg, one_neg), 256), 254);
    }
