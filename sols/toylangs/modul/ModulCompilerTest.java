...
public class ModulCompilerTest {
    ...
    public void test07_overflow_pow() {
        checkCompile(prog(pow(num(2), 100), 7), 2);
        checkCompile(prog(pow(num(2), 100), 1009), 164);
        checkCompile(prog(pow(num(7), 100), 1009), 227);
        checkCompile(prog(pow(num(1000000000), 2), 1009), 707); // kas vahepealne num on ka normaliseeritud?
    }

    @Test
    public void test08_multiple() {
        ModulPow one = pow(neg(num(1)), 10);
        ModulPow one_neg = pow(neg(num(1)), 9);
        checkCompile(prog(one, 256), 1);
        checkCompile(prog(one_neg, 256), 255);
        checkCompile(prog(add(one, one), 256), 2);
        checkCompile(prog(add(one_neg, one), 256), 0);
        checkCompile(prog(add(one_neg, one_neg), 256), 254);
    }
